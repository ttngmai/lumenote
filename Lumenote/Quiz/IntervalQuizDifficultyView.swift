...
/// Chooses difficulty and length, then runs the interval quiz in place.
...
struct IntervalQuizDifficultyView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: LumenoteSpacing.section) {
                ...
                VStack(spacing: LumenoteSpacing.md) {
                    ForEach(IntervalQuizDifficulty.allCases) { difficulty in
                        Button {
    ...
    private func difficultyRow(_ difficulty: IntervalQuizDifficulty, isSelected: Bool) -> some View {
    ...
    private func result(_ model: IntervalQuizModel) -> some View {
        ScrollView {
            VStack(alignment: .leading, spacing: LumenoteSpacing.section) {
                Text("퀴즈를 마쳤습니다")
                    .font(LumenoteFont.callout(.medium))
