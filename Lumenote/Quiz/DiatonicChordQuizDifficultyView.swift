...
/// Chooses difficulty and length, then runs the diatonic-chord quiz in place.
...
struct DiatonicChordQuizDifficultyView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: LumenoteSpacing.section) {
                ...
                VStack(spacing: LumenoteSpacing.md) {
                    ForEach(DiatonicChordQuizDifficulty.allCases) { difficulty in
                        Button {
    ...
    private func difficultyRow(_ difficulty: DiatonicChordQuizDifficulty, isSelected: Bool) -> some View {
    ...
    private func result(_ model: DiatonicChordQuizModel) -> some View {
        ScrollView {
            VStack(alignment: .leading, spacing: LumenoteSpacing.section) {
                Text("퀴즈 풀이 결과")
